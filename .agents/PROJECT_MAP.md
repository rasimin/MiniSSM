...
18. Menu `Tools > SQL Agent Monitor` membuka `SqlAgentWindow` menggunakan koneksi tab aktif, memonitor status Agent, dan membaca/menjalankan operasi job melalui database `msdb`; detail job menyediakan tab Steps, Schedules, dan History.
